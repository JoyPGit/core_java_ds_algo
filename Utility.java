...
public class Utility {
    ...
    Here we are using Integer.parseInt(String) method to convert 
    the given char to int. Since this method accepts string argument 
    we are converting char to String using String.valueOf() method 
    and then passing the converted value to the method.
    */
